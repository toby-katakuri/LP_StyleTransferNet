...
from BaseNet import BaseNet, BaseNet_Test
...
para_path = r'F:\pyproject\lap_cin\saved_paras\001_3'
...
for epoch in range(epochs):
    ...
    for data in tqdm(data_loader):
        ...
        style = F.interpolate(data['style'], [128, 128])
        stylized = net2.test_image_time(content_pyr[-1].cuda(), style.cuda())
        net.set_input(content_pyr, data['content'], data['style'], stylized, data['content_edge'])
